...
<p align="left">I'm an enthusiastic <b>Full Stack Developer</b>. Currently working on building a Meal tracking app. I'm always excited to dive deeper into software development, enhance my skillset, and contribute to impactful projects.<br><br>🔧 Skills & Tools<br>Languages: TypeScript, JavaScript, Python, C<br>Frontend: Next.js, React<br>Backend: Node.js, Express, MongoDB, Mongoose<br>Authentication: Custom Auth System, Clerks<br>Others: Git, Vercel, Cloudinary API<br><br>🌱 What I'm Learning<br>Building custom authentication to understand security fundamentals<br>Creating scalable and interactive full-stack applications with a focus on real-time features</p>
